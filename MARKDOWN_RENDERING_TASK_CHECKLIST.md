...
1. 验收 T07、T09、T11，并完成 T12 的暗黑截图检查。
2. 修复 T05：侧栏方向锁、边缘起手区和横向滚动让权。
3. 完成 T13：公式和流程图双 Image 缓冲。
4. 为 F04 建立最小复现页并整理框架报告。
5. 向框架确认 F05，再设计和实现 T01-T02 的完整子线程架构。
6. 将 F01-F03 连同性能报告正式提交框架，并记录对应 issue/负责人。
