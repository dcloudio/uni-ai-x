const { UniCloudError } = require("../../../common/error");
const { camel2snakeJson, snake2camelJson } = require("../../../common/utils");
...
async function callWxOpenApi({ name, url, data, options, defaultOptions }) {
  let result = {};
